...
void init_irq(void) {
	...
	// Install the context-switching interrupt
	// Need to register this under 0x3C since the interrupts are called
	// as decimal numbers, not hexadecimal
	idt_set_gate(0x3C, (u32int) sys_call_isr, 0x08, 0x8e);
}
